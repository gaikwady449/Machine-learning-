...
#------------------------------------------------------
#   Function name : VisulixeTitanicData 
...
def  VisualizeTitanicData(df): 
    DisplayInfo("Step : Data Visualization")
...
#   Date :          14/03/2026
#   Author :        Yash Chndrakant Gaikwad
#--------------------------------------------------------
...
def MarvellousTitanicLogistic(DataPath):
    ...
    VisualizeTitanicData(df)   # <-- Add this line
